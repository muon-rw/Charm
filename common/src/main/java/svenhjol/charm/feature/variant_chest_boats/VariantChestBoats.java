...
@Feature(mod = Charm.MOD_ID, switchable = false, description = "Registers variant chest boats.")
public class VariantChestBoats extends CharmFeature {
    ...
    public void register() {
        BOAT_RECIPE = Charm.REGISTRY.recipeSerializer(BOAT_RECIPE_ID,
    ...
    public static void registerChestLayerColor(IVariantMaterial material) {
