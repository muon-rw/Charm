...
import svenhjol.charm_api.iface.IGrindsItems;
...
public class GrindableArmor extends CharmFeature implements IGrindsItems {
    ...
    public void runWhenEnabled() {
        ...
        CharmApi.getProviderData(IGrindsItems.class, provider -> provider.getItemGrindResults().stream())
