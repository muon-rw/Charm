...
public class AtlasesClient extends CharmFeature {
    public static final RenderType ATLAS_BACKGROUND = RenderType.text(Charm.makeId("textures/map/atlas.png"));
    public static final RenderType MAP_BACKGROUND = RenderType.text(new ResourceLocation("textures/map/map_background.png"));
    static final ResourceLocation CONTAINER_BACKGROUND = Charm.makeId("textures/gui/atlas.png");
