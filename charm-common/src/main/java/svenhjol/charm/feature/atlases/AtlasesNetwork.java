...
public class AtlasesNetwork {
    public static void register() {
        Charm.REGISTRY.packet(new TransferAtlas(), () -> Atlases::handleTransferAtlas);
        Charm.REGISTRY.packet(new SwapAtlasSlot(), () -> Atlases::handleSwappedSlot);
        Charm.REGISTRY.packet(new SwappedAtlasSlot(), () -> AtlasesClient::handleSwappedSlot);
        Charm.REGISTRY.packet(new UpdateInventory(), () -> AtlasesClient::handleUpdateInventory);
    }
