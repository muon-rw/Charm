...
import svenhjol.charm_api.iface.IHasEnchantments;
...
public class EnchantableHorseArmor extends CharmFeature implements IHasEnchantments {
    ...
    public static List<Enchantment> getAllEnchantments() {
        return CharmApi.getProviderData(IHasEnchantments.class,
