...
@Feature(mod = Charm.MOD_ID, switchable = false, description = "A status effect that causes all living entities around the player to glow.")
public class Echolocation extends CharmFeature {
    ...
    public void register() {
        MOB_EFFECT = Charm.REGISTRY.mobEffect(ID, EcholocationStatusEffect::new);
    }
