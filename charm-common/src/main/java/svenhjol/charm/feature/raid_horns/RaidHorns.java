...
public class RaidHorns extends CharmFeature implements IProvidesWandererTrades {
    ...
    public void register() {
        ITEM = Charm.REGISTRY.item("raid_horn", () -> new RaidHornItem(this));
        CALL_PATROL_SOUND = Charm.REGISTRY.soundEvent("raid_horn_call_patrol");
        CALL_OFF_RAID_SOUND = Charm.REGISTRY.soundEvent("raid_horn_call_off_raid");
        FAIL_SOUND = Charm.REGISTRY.soundEvent("raid_horn_squeak");
